...
instant another update holds it: `list` and `show` wait at most 3 seconds behind a writer before
saying `the index is held by another update`, since a process stopped mid-update holds it until it
