...
- Q: Which concrete sinks ship first? → A: Three — Discord, Slack, and GitHub issues. Two messaging implementations validate the sink interface properly, and no further sink type is needed for this feature.
